...
```bash
node .claude/dev-workflow/skills/clickup/query.mjs <command> [options]
```
...
```bash
# Using full URL
node .claude/dev-workflow/skills/clickup/query.mjs get "https://app.clickup.com/t/86a1b2c3d"

# Using task ID directly
node .claude/dev-workflow/skills/clickup/query.mjs get 86a1b2c3d

# Include subtasks
node .claude/dev-workflow/skills/clickup/query.mjs get 86a1b2c3d --subtasks
```
...
node .claude/dev-workflow/skills/clickup/query.mjs create 901111220963 "New feature: dark mode"

# Using default list (if CLICKUP_DEFAULT_LIST_ID is set)
node .claude/dev-workflow/skills/clickup/query.mjs create "Quick task"
```
...
node .claude/dev-workflow/skills/clickup/query.mjs my-tasks
```

### Search Tasks

```bash
node .claude/dev-workflow/skills/clickup/query.mjs search "authentication"
```
...
node .claude/dev-workflow/skills/clickup/query.mjs status 86a1b2c3d

# Update status (case-insensitive, partial match)
node .claude/dev-workflow/skills/clickup/query.mjs status 86a1b2c3d "in progress"
node .claude/dev-workflow/skills/clickup/query.mjs status 86a1b2c3d "complete"
```
...
```bash
# Assign by username
node .claude/dev-workflow/skills/clickup/query.mjs assign 86a1b2c3d justin

# Assign by email
node .claude/dev-workflow/skills/clickup/query.mjs assign 86a1b2c3d jane@example.com
```

### Set Due Dates

```bash
node .claude/dev-workflow/skills/clickup/query.mjs due 86a1b2c3d "tomorrow"
node .claude/dev-workflow/skills/clickup/query.mjs due 86a1b2c3d "next friday"
node .claude/dev-workflow/skills/clickup/query.mjs due 86a1b2c3d "+3d"
node .claude/dev-workflow/skills/clickup/query.mjs due 86a1b2c3d "2024-01-15"
```

### Set Priority

```bash
node .claude/dev-workflow/skills/clickup/query.mjs priority 86a1b2c3d urgent
node .claude/dev-workflow/skills/clickup/query.mjs priority 86a1b2c3d high
node .claude/dev-workflow/skills/clickup/query.mjs priority 86a1b2c3d none  # Clear priority
```

### Create Subtasks

```bash
node .claude/dev-workflow/skills/clickup/query.mjs subtask 86a1b2c3d "Write unit tests"
node .claude/dev-workflow/skills/clickup/query.mjs subtask 86a1b2c3d "Update documentation"
```

### Move Tasks

```bash
node .claude/dev-workflow/skills/clickup/query.mjs move 86a1b2c3d 901111220964
```
...
node .claude/dev-workflow/skills/clickup/query.mjs link 86a1b2c3d "https://github.com/..." "PR #123"

# Add link without description
node .claude/dev-workflow/skills/clickup/query.mjs link 86a1b2c3d "https://docs.example.com/guide"
```

### Add Checklist Items

```bash
node .claude/dev-workflow/skills/clickup/query.mjs checklist 86a1b2c3d "Review code"
node .claude/dev-workflow/skills/clickup/query.mjs checklist 86a1b2c3d "Run tests"
node .claude/dev-workflow/skills/clickup/query.mjs checklist 86a1b2c3d "Deploy to staging"
```
...
```bash
# All tasks in a list
node .claude/dev-workflow/skills/clickup/query.mjs tasks 901111220963

# Only tasks assigned to me
node .claude/dev-workflow/skills/clickup/query.mjs tasks 901111220963 --me
```

### View Comments

```bash
node .claude/dev-workflow/skills/clickup/query.mjs comments "https://app.clickup.com/t/86a1b2c3d"
```

### Post a Comment

```bash
node .claude/dev-workflow/skills/clickup/query.mjs comment 86a1b2c3d "Starting work on this task"

# Multi-line comment
node .claude/dev-workflow/skills/clickup/query.mjs comment 86a1b2c3d "Status update:
...
node .claude/dev-workflow/skills/clickup/query.mjs delete-comment 90110200841741
```
...
node .claude/dev-workflow/skills/clickup/query.mjs watch 86a1b2c3d koen

# Notify by email
node .claude/dev-workflow/skills/clickup/query.mjs watch 86a1b2c3d jane@example.com
```
...
```bash
# Add a tag to a task
node .claude/dev-workflow/skills/clickup/query.mjs tag 86a1b2c3d "DevOps"
node .claude/dev-workflow/skills/clickup/query.mjs tag 86a1b2c3d "bug"
```
...
node .claude/dev-workflow/skills/clickup/query.mjs description 86a1b2c3d "## Summary
...
node .claude/dev-workflow/skills/clickup/query.mjs docs

# Search docs by name
node .claude/dev-workflow/skills/clickup/query.mjs docs "API"
```
...
node .claude/dev-workflow/skills/clickup/query.mjs doc abc123def

# Using a doc URL
node .claude/dev-workflow/skills/clickup/query.mjs doc "https://app.clickup.com/12345/v/dc/abc123def"
```
...
```bash
# Create an empty doc
node .claude/dev-workflow/skills/clickup/query.mjs create-doc "Project Notes"

# Create a doc with initial content (populates the first page)
node .claude/dev-workflow/skills/clickup/query.mjs create-doc "API Documentation" --content "# API Documentation
...
node .claude/dev-workflow/skills/clickup/query.mjs page abc123def page456
```
...
node .claude/dev-workflow/skills/clickup/query.mjs create-page abc123def "New Section"

# Create a page with content
node .claude/dev-workflow/skills/clickup/query.mjs create-page abc123def "Getting Started" --content "# Welcome
...
```bash
# Update page content
node .claude/dev-workflow/skills/clickup/query.mjs edit-page abc123def page456 --content "Updated content here"

# Rename a page
node .claude/dev-workflow/skills/clickup/query.mjs edit-page abc123def page456 --name "New Page Name"

# Update both content and name
node .claude/dev-workflow/skills/clickup/query.mjs edit-page abc123def page456 --content "New content" --name "New Name"
```
